...
export default function Home() {
    ...
    return (
        <React.Fragment>
            <section className="flex flex-row px-8 py-10 gap-5 w-full h-full">
                <section className="grid grid-cols-4 gap-5 grid-rows-5 h-full w-2/3">
                    ...
                    <div className="col-span-4 row-span-2 space-y-4 overflow-scroll">
                        <h2 className="font-semi-bold text-2xl">Progression formations </h2>
                        {/* progression */}
                    ...
                    <div className="col-span-4 row-span-2 space-y-4 overflow-x-auto flex flex-wrap">
                        <h2 className="font-semi-bold text-2xl">Dernières actualités </h2>
                        {/* progression */}
                        <div className="p-5 bg-white rounded-md drop-shadow-lg flex flex-col ">
                            <div className="overflow-hidden">
                            <div className="grid grid-cols-3 gap-4">
                            {news.map((item) => (
                                <div key={item.id} className="bg-white rounded-lg shadow-md text-center">
                                <img
                                    src={item.image}
                                    alt={item.title}
                ...
                <section className="grid grid-cols-2 gap-5 grid-rows-2 w-1/3">
                    <div className="col-span-2 space-y-4 overflow-scroll">
                    ...
                    <div className="flex flex-col bg-carbon-white rounded-md drop-shadow-xl">
                        ...
                        <div className="p-3 w-full space-y-3">
                            ...
                            <div className="flex items-center flex-col sm:flex-row space-y-4 sm:space-y-0 space-x-4 p-4 bg-white rounded-lg shadow-md">
