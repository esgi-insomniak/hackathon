...
const collection = require("./pb_schema.json");
...
import("pocketbase")
  .then((module) => {
    ...
    pb.admins
      ...
      .then((createdRecord) => {
        pb.admins
          .authWithPassword("new@example.com", "1234567890")
          .then((response) => {
            pb.collections.import(collection).then(() => {
              ...
              createQuizAnswer(quiz_answer, quizzAnswerId).then(
                (quizzAnswerId) => {
                  ...
                  createQuizQuestion(quizz_question, quizzAnswerId).then(
                    (quizzQuestionId) => {
                      ...
                      createQuizz(quizz, quizzQuestionId).then((quizId) => {
                        ...
                        createFormation(formations, quizId).then(
                          (formationId) => {
